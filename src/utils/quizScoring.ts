...
// Helper function to print debug messages with color coding
const print_message = (message: string, type: 'error' | 'warning' | 'info' = 'info') => {
...
// Calculate creator score based on quiz answers
export const calculateCreatorScore = (data: QuizFormData): QuizResult => {
  let score = 0;
  ...
  print_message(`Quiz score calculated: ${normalizedScore}`, 'info');
